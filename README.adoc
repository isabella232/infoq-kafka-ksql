= InfoQ - Apache Kafka and KQL article - code samples
...
You can find a related suplemental article on the link:https://www.confluent.io/blog[Confluent blog], "The Changing Face of ETL".
