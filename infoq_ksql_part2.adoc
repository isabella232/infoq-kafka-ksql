...
and now use it for ad-hoc analysis through numerous tools, including Amazon's own Athena: 
...
CREATE EXTERNAL TABLE ratings (
 ...
 LOCATION 's3://rmoff-demo-ratings/topics/ratings-with-customer-data/partition=0/';
