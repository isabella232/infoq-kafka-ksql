...
Let's take a look in detail at the detail of building this. You can find the code for all of the examples, along with a docker-compose files, https://github.com/confluentinc/infoq-kafka-ksql[on github].
